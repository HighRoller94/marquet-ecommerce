                ...
                <div class="nav__secondary">
                    <ul class="nav__menu">
                        ...
                        <li class="navbar__item">
                            <a href="/mens.html" class="navbar__links">Mens</a>
                        </li>
                        <li class="navbar__item">
                            <a href="/womens.html" class="navbar__links">Womens</a>
                        </li>
                        <li class="navbar__item">
                            <a href="/footwear.html" class="navbar__links">Footwear</a>
                        </li>
                        <li class="navbar__item">
                            <a href="/homeware.html" class="navbar__links">Homeware</a>
                        </li>
                        <li class="navbar__item">
